...
const Notification = () => {
  ...
  useEffect(() => {
    ...
    const Responder = Notifications.addNotificationResponseReceivedListener(
      (item) => {
  ...
  return (
    <SafeAreaView style={{ flex: 1 }}>
      <View style={{ flex: 1, justifyContent: "center", alignItems: "center" }}>
        <Button mode="contained" icon="bell" onPress={GenerateToken}>
          Token
        </Button>
      </View>
      <View style={{ flex: 1, justifyContent: "center", alignItems: "center" }}>
        {Token ? (
          ...
          <Text style={{ fontSize: 30 }}>NO Token</Text>
        )}
      </View>
    </SafeAreaView>
  );
